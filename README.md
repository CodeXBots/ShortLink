...
![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=AN+ADVANCE+FILE+STORE+BOT+;WITH+PERMANENT+LINKS+,+CUSTOM+URL+;SHORTNER+, +TOKEN+VERIFICATION+;AND+MANY+MORE+UNIQUE+FEATURES+;CREATED+BY+RAHUL)
</p>
