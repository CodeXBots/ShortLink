...
![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=AN+ADVANCE+FILE+STORE+BOT+;WITH+PERMANENT+LINKS+,+CUSTOM+URL+;SHORTNER+,+TOKEN+VERIFICATION+,+;ClONE+,+STREAM/DOWNLOAD+FEATURES+;CREATED+BY+RAHUL)
</p>
